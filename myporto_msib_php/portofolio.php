        ...
        <div class="portfolio-works wow fadeIn" data-wow-duration="2s">
            ...
            <div id="portfolio-filter" class="portfolio-filter-btn-group">
                <ul>
                    <li>
                        ...
                        <!--
                         --><a href="#" data-filter=".web">Studio</a>
                        <!--
                         --><a href="#" data-filter=".seo">Photography</a>
                        <!--
                         --><a href="#" data-filter=".works">Storybook</a>
                        <!--
                         --><a href="#" data-filter=".brands">Branding</a>
                    </li>
                </ul>
            </div>
            <!-- Filter Button End -->
            ...
            <div class="portfolio-items">
                ...
                <div class="item portfolio-item web seo">
                    ...
                    <img src="images/porto/1.png" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/porto/1.png" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item portfolio-item works seo">
                    ...
                    <img src="images/porto/2.png" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/porto/2.png" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item portfolio-item web">
                    ...
                    <img src="images/porto/3.png" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/porto/3.png" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item portfolio-item brands seo">
                    ...
                    <img src="images/porto/4.png" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/porto/4.png" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
